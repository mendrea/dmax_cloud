...
Discounts
	...
	Ensure Category list contains [Discounts] value

	I select [Discounts] from the category list with code [AL9997] and description [Discount - Allergens]
	...
	Ensure invoice with Medical Record Entry [Discount - Allergens] is shown

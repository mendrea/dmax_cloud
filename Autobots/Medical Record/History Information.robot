...
History Information
	...
	Ensure Category list contains [History Information] value

	I select [History Information] from the category list with code [NP0011] and description [Cruciate Aftercare Instruction]
	...
	Ensure invoice with Medical Record Entry [Cruciate Aftercare Instruction] is shown

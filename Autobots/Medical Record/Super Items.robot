...
Super Items
	...
	Ensure Category list contains [Super Items] value

	I select [Super Items] from the category list with code [SI005] and description [*Anesthesia General]
	...
	Ensure invoice with Medical Record Entry [*Anesthesia General] is shown

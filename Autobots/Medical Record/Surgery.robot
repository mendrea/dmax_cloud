...
Surgery
	...
	Ensure Category list contains [Surgery] value

	I select [Surgery] from the category list with code [Sx005] and description [Abdominocentesis]
	...
	Ensure invoice with Medical Record Entry [Abdominocentesis] is shown

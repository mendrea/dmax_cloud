...
Professional Services
	...
	Ensure Category list contains [Professional Services] value

	I select [Professional Services] from the category list with code [PS987] and description [Clip, clean, and debride wound]
	...
	Ensure invoice with Medical Record Entry [Clip, clean, and debride wound] is shown

...
Hospital Supply
	...
	Ensure Category list contains [Hospital Supply] value

	I select [Hospital Supply] from the category list with code [NP0011] and description [Cruciate Aftercare Instruction]

...
Hospitalization
	...
	Ensure Category list contains [Hospitalization] value

	I select [Hospitalization] from the category list with code [Ho005] and description [Day Care-Hospitalization]
	...
	Ensure invoice with Medical Record Entry [Day Care-Hospitalization] is shown

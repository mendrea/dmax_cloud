...
Medical Treatment
	...
	Ensure Category list contains [Medical Treatment] value

	I select [Medical Treatment] from the category list with code [MT005] and description [Administer Pets own meds]
	...
	Ensure invoice with Medical Record Entry [Administer Pets own meds] is shown

...
Pet Products
	...
	Ensure Category list contains [Pet Products] value

	I select [Pet Products] from the category list with code [PP040] and description [Clear Tar Shampoo 8oz]
	...
	Ensure invoice with Medical Record Entry [Clear Tar Shampoo 8oz] is shown

...
Injection
	...
	Ensure Category list contains [Injection] value

	I select [Injection] from the category list with code [In005] and description [Acepromazine Inject.]
	...
	Ensure invoice with Medical Record Entry [Acepromazine Inject.] is shown

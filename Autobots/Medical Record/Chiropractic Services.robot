...
Chiropractic Services
	...
	Ensure Category list contains [Chiropractic Services] value

	I select [Chiropractic Services] from the category list with code [CS1030] and description [Acupuncture - Additional Session]
	...
	Ensure invoice with Medical Record Entry [Acupuncture - Additional Session] is shown

...
Location Transfer
	...
	Ensure Category list contains [Location Transfer] value

	I select [Location Transfer] from the category list with code [NP0011] and description [Cruciate Aftercare Instruction]

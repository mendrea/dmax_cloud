...
Antiparasitic
	...
	Ensure Category list contains [Antiparasitic] value

	I select [Antiparasitic] from the category list with code [AP005] and description [Amitraz]
	...
	Ensure invoice with Medical Record Entry [Amitraz] is shown

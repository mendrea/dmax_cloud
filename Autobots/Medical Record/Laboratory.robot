...
Laboratory
	...
	Ensure Category list contains [Laboratory] value

	I select [Laboratory] from the category list with code [La383] and description [Warfarin]
	...
	Ensure invoice with Medical Record Entry [Warfarin] is shown

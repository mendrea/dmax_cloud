...
Boarding
	...
	Ensure Category list contains [Boarding] value
	I select [Boarding] from the category list with code [Bo9997] and description [Discount - Boarding]
	...
	Ensure invoice with Medical Record Entry [Discount - Boarding] is shown

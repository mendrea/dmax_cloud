...
Anesthesia
	...
	Ensure Category list contains [Anesthesia] value

	I select [Anesthesia] from the category list with code [AN010] and description [*Anest-Dental Halo. 25-50 lbs.]
	...
	Ensure invoice with Medical Record Entry [*Anest-Dental Halo. 25-50 lbs.] is shown

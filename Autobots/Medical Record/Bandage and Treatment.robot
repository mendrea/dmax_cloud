...
Bandage and Treatment
	...
	Ensure Category list contains [Bandage and Treatment] value

	I select [Bandage and Treatment] from the category list with code [BT005] and description [Abscess Drain & Lance]
	...
	Ensure invoice with Medical Record Entry [Abscess Drain & Lance] is shown

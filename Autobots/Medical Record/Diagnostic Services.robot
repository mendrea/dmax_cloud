...
Diagnostic Services
	...
	Ensure Category list contains [Diagnostic Services] value

	I select [Diagnostic Services] from the category list with code [Dx2000] and description [Avian Gram Stain]
	...
	Ensure invoice with Medical Record Entry [Avian Gram Stain] is shown

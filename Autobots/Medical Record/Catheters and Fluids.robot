...
Catheters and Fluids
	...
	Ensure Category list contains [Catheters and Fluids] value

	I select [Catheters and Fluids] from the category list with code [CF010] and description [IV Catheter Placement]
	...
	Ensure invoice with Medical Record Entry [IV Catheter Placement] is shown

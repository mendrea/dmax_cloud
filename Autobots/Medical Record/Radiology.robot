...
Radiology
	...
	Ensure Category list contains [Radiology] value

	I select [Radiology] from the category list with code [XR005] and description [Barium Administration]
	...
	Ensure invoice with Medical Record Entry [Barium Administration] is shown

...
Vaccinations
	...
	Ensure Category list contains [Vaccinations] value

	I select [Vaccinations] from the category list with code [Vx005] and description [Bordetella I.N. Booster]
	...
	Ensure invoice with Medical Record Entry [Bordetella I.N. Booster] is shown

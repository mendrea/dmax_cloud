...
Dental Services
	...
	Ensure Category list contains [Dental Services] value

	I select [Dental Services] from the category list with code [DS015] and description [Dental Cleaning-Feline]
	...
	Ensure that element is visible  //div[@data-title='Super Item DS015: Dental Cleaning-Feline']

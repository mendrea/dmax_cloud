...
Rehabilitation Services
	...
	Ensure Category list contains [Rehabilitation Services] value

	I select [Rehabilitation Services] from the category list with code [RS1010] and description [Rehab - Full Session ]
	...
	Ensure invoice with Medical Record Entry [Rehab - Full Session ] is shown

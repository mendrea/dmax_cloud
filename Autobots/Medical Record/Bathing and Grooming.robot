...
Bathing and Grooming
	...
	Ensure Category list contains [Bathing and Grooming] value

	I select [Bathing and Grooming] from the category list with code [BG010] and description [Bath-Clean Up ]
	...
	Ensure invoice with Medical Record Entry [Bath-Clean Up ] is shown

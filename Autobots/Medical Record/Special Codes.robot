...
Special Codes
	...
	Ensure Category list contains [Special Codes] value

	I select [Special Codes] from the category list with code [*WT] and description [Weight (QTY in Lbs)]
	...
	#Ensure check boxes are present
	#Ensure that element is visible  //span[.='Notes']
	I [Save Medical Record Entry] the selected form
	Ensure invoice with Medical Record Entry [Weight (QTY in Lbs)] is shown
